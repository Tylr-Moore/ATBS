...
print('What number I am thinking of between 1 and 100? Be careful, you only have ' + str(attempts) + ' guesses!') # made "attempts" variable to print 6 prior to range being declared in part 2
